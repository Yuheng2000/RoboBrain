...
export BASE_RUN_NAME=resume_finetune_Llava-Onevision-siglip-qwen2.5-stage-2_si

export PREV_STAGE_CHECKPOINT=/home/vlm/workspace/checkpoints/direct_finetune_Llava-Onevision-siglip-qwen2.5-stage1_5
export VISION_MODEL_VERSION=/home/vlm/pretrain_model/siglip-so400m-patch14-384

export DATA_PATH=/home/vlm/finetune_json/yaml/onevision-2_si.yaml
